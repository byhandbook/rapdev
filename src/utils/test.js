  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    const MobileFilters = {
      ...
      init() {
        ...
        if (!modal || !openBtn || !closeBtn || !applyBtn || !clearBtn || !totalFilters || !totalWrapper || !menuIcon) {
          return;
        }
        this.elements = {
          modal,
      ...
      takeSnapshot() {
        ...
        if (!modal) return;
        if (fsInstance) {
          this.snapshotState = /* @__PURE__ */ new Map();
      ...
      restoreSnapshot() {
        ...
        if (fsInstance && this.snapshotState instanceof Map) {
          fsInstance.filtersData.forEach((data, key) => {
            const saved = this.snapshotState.get(key) || /* @__PURE__ */ new Set();
